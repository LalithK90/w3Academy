...
import lk.w3Academy.asset.student.controller.StudentController;
import lk.w3Academy.asset.student.dao.StudentFilesDao;
...
public class StudentFilesService {
    ...
    @Autowired
    public StudentFilesService(StudentFilesDao studentFilesDao) {
