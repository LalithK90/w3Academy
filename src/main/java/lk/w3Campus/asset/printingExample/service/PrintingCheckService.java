package lk.w3Campus.asset.printingExample.service;
...
import lk.w3Campus.asset.employee.dao.EmployeeDao;
...
public class PrintingCheckService {
    ...
    public PrintingCheckService(EmployeeDao employeeDao) {
    ...
    public ByteArrayInputStream createPDF() throws DocumentException {
        ...
        for (Employee employee : employeeDao.findAll()) {
            ...
            PdfPCell mobileValue = new PdfPCell(new Paragraph(employee.getMobileOne(), tableHeader));
