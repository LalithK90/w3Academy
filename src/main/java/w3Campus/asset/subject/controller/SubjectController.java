package w3Campus.asset.subject.controller;


import w3Campus.asset.employee.service.EmployeeService;
import w3Campus.asset.semester.service.SemesterService;
import w3Campus.asset.subject.entity.Enum.EmployeeRoleSubject;
...
public class SubjectController implements AbstractController<Subject, Long> {
    ...
    public String addEmployeeToSubject(@PathVariable Long id, Model model) {
        ...
        return "subject/addEmployeeToSubject";
    }
