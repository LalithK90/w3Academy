...
public class MakeAutoGenerateNumberService {
    ...
    public String numberAutoGen(String lastNumber, String textPart) {
        ...
        if (lastNumber != null) {
            lastNumber = lastNumber.substring(textPart.length());
            ...
            if (currentYearLastTwoNumber == newNumberFirstTwoCharacters) {
                ...
                newNumber = previousNumber + 100000;
            }
        } else {
            newNumber = Integer.parseInt(textPart + currentYearLastTwoNumber + "00000");
        }
